...
export default function ForgotPasswordPage() {
  ...
  const onSubmit = async (data: ForgotFormValues) => {
    try {
      ...
      setStatus("success");
      setMessage("A recovery link has been generated for your account.");
            ...
            <div className="text-center space-y-6">
              ...
              {devLink && (
                <div className="mt-6 p-4 border border-accent/30 bg-accent/5 rounded-xl text-left">
                  ...
                  <p className="text-sm text-muted-foreground font-light mb-4">Click below to test the reset flow directly:</p>
                  <Link href={devLink}>
